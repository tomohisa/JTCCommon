...
// nv-ios-version
#define COCOAPODS_POD_AVAILABLE_nv_ios_version
#define COCOAPODS_VERSION_MAJOR_nv_ios_version 0
#define COCOAPODS_VERSION_MINOR_nv_ios_version 1
#define COCOAPODS_VERSION_PATCH_nv_ios_version 0
